...
def main():
    ...
    files = glob.glob("experiment_1_lfr_results_*.csv")
    if not files:
    ...
    ax1.set_title('LFR Scaling: Median Time vs Graph Size')
    ax1.set_yscale('log')
    ...
    output_path = "plot_lfr_n_scaling.pdf"
