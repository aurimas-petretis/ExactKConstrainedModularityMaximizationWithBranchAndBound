"""
Experiment 1: Size Scaling Analysis on ABCD Benchmark
...
def generate_abcd_graph(n):
    """Generate ABCD benchmark graph with given size and seed."""
...
def run_algorithm_worker(args):
    ...
    try:
        if algorithm_name == 'gurobi':
            ...
            optimal = None  # Will be determined by comparison with bnb_c
...
def main():
    ...
    csv_path = os.path.join(output_dir, f"experiment_1_abcd_results_{timestamp}.csv")
